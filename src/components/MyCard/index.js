...
const MyCard = ({title, subTitle, avatar}) => (
    <>
        <Card>
            <div className='banner'>
                ...
                <ul>
                    <li>
                        <Anchor link="https://www.instagram.com/abiltongd/">
                            <FaInstagram size={22} color='#fff'/>
                        </Anchor>
                    </li>
                    <li>
                        <Anchor link='https://www.linkedin.com/in/AbiltonDias/'>
                            <FaLinkedin size={22} color='#fff'/>
                        </Anchor>
                    </li>
                    <li>
                            <Anchor link="https://github.com/AbiltonDias">
                                <FaGithub size={22} color="#fff" />
                            </Anchor>
                    </li>
                    <li>
                            <Anchor link="https://twitter.com/AbiltonDias">
